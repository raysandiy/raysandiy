...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $kategori_id = $_POST['kategori_id']; // Mengambil nilai dari elemen dropdown yang sudah diperbarui namanya
...
<div class="container mt-4">
    ...
    <select class="form-select" id="kategori" name="kategori_id"> <!-- Ubah nama elemen menjadi "kategori_id" -->
    <?php foreach ($kategoribuku as $kategori_item): ?>
        <option value="<?= $kategori['id'] ?? ''; ?>" <?= (isset($buku['kategori_id']) && $buku['kategori_id'] == $kategori['id']) ? 'selected' : ''; ?>>
